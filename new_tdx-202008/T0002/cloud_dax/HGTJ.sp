...
FoldArrowFlag=0
CurUrlSel=0
Url=http://fast.icfqs.com/site/apps/jrzdym/jrzdym/hgrz_year.html?color=##tdxbk##&bkcolor=##tdxbkcolor##
ZSCheck=1
AutoRefreshMin=0
ForceUseIECheck=0
...
FoldArrowFlag=0
CurUrlSel=0
Url=http://fast.icfqs.com/site/apps/jrzdym/jrzdym/hgrz_month.html?rq=##WEBDATACODE##&color=##tdxbk##&bkcolor=##tdxbkcolor##
ZSCheck=1
AutoRefreshMin=0
ForceUseIECheck=0
WebBkgSameForScheme=1
