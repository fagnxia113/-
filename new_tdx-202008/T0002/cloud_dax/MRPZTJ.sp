...
PadMaxCy=0
PadHelpStr=交易规则
PadHelpUrl=http://fast.icfqs.com/site/apps/zyyjb/help/jygz.html?type=pc&tdxmyietitle=交易规则&tdxmyiewidth=1024&tdxmyieheight=768&canchangesize=0
HasProcessBtn=0
UnSizeMode=0
HQGridNoCode=0
crTipWord=0
...
SwitchBarScheme=0
CurUrlSel=0
Url=http://hot.icfqs.com:7615/site/pcwebcall/html/pc_pztj_mrpmtj.html?color=##tdxbk##&bkcolor=##tdxbkcolor##&nomenu=1
ZSCheck=1
AutoRefreshMin=0
ForceUseIECheck=0
