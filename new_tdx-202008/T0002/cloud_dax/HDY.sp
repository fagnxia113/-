...
PadMaxCy=0
PadHelpStr=热门互动>>
PadHelpUrl=http://www.treeid/syszdpadcode_hdwd
HasProcessBtn=0
UnSizeMode=0
HQGridNoCode=0
crTipWord=0
...
FoldArrowFlag=0
CurUrlSel=0
Url=http://##tdxcloudaddress_tp##/site/tdx-pc-zx/page-index.html?color=##tdxbk##&bkcolor=##tdxbkcolor##&menu=hd
ZSCheck=1
AutoRefreshMin=0
ForceUseIECheck=0
