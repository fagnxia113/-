  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[1680px] px-3 py-3 sm:px-4 sm:py-4 lg:px-5">
        <aside
          className={cn(
            'sticky top-3 z-40 hidden shrink-0 overflow-visible rounded-lg border border-[var(--shell-sidebar-border)] bg-card/80 p-3 shadow-soft-card backdrop-blur-sm transition-[width] duration-200 lg:flex',
