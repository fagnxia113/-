...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "PYTDX_CONNECT_TIMEOUT": {
        "title": "Pytdx Connect Timeout",
        "description": "Seconds to wait for one Tongdaxin server connection attempt.",
        "category": "data_source",
        "data_type": "float",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "default_value": "1.2",
        "options": [],
        "validation": {"min": 0.2, "max": 5.0},
        "display_order": 58,
    },
    "PYTDX_MAX_CONNECT_HOSTS": {
        "title": "Pytdx Max Connect Hosts",
        "description": "Maximum Tongdaxin public servers to probe for one quote request.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PYTDX_SERVER_COOLDOWN": {
        "title": "Pytdx Server Cooldown",
        "description": "Seconds to skip a Tongdaxin server after a failed connection attempt.",
        "category": "data_source",
        "data_type": "float",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PYTDX_REUSE_CONNECTION": {
        "title": "Pytdx Reuse Connection",
        "description": "Reuse a successful Tongdaxin connection inside the data fetcher instance.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "checkbox",
        "is_sensitive": False,
    ...
    "AGENT_ARCH": {
        ...
        "description": "Agent execution architecture. 'single' uses the classic ReAct executor; 'multi' uses the orchestrator pipeline with specialised sub-agents including debate.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "AGENT_ORCHESTRATOR_MODE": {
        ...
        "description": "Pipeline mode when AGENT_ARCH=multi. 'debate' (tech→intel→risk→industry→capital_flow→debate→factor_scoring→decision), 'full_debate' (full + fundamental + sentiment + debate), 'full' (tech→intel→risk→decision).",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            {"label": "Debate (推荐)", "value": "debate"},
            {"label": "Full Debate (深度)", "value": "full_debate"},
            {"label": "Full", "value": "full"},
            {"label": "Enhanced", "value": "enhanced"},
            {"label": "Standard", "value": "standard"},
            {"label": "Quick", "value": "quick"},
        ],
        "validation": {"enum": ["quick", "standard", "full", "enhanced", "specialist", "debate", "full_debate", "strategy", "skill"]},
        "display_order": 61,
    },
