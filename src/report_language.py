...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "factor_scores_heading": "多维度评分",
        "factor_technical_label": "技术面",
        "factor_fundamental_label": "基本面",
        "factor_sentiment_label": "情绪面",
        "factor_capital_flow_label": "资金面",
        "factor_composite_label": "综合",
        "financial_metrics_heading": "核心财务指标",
        "pe_ratio_label": "市盈率(PE)",
        "pb_ratio_label": "市净率(PB)",
        "roe_label": "净资产收益率(ROE)",
        "debt_ratio_label": "资产负债率",
        "revenue_growth_label": "营收增速",
        "profit_growth_label": "利润增速",
        "dividend_yield_label": "股息率",
        "market_cap_label": "市值",
        "sector_comparison_heading": "行业对比",
        "sector_name_label": "所属行业",
        "sector_rank_label": "行业排名",
        "sector_trend_label": "行业趋势",
        "peer_avg_pe_label": "同业平均PE",
        "relative_strength_label": "相对强度",
        "sector_leading_label": "行业龙头",
        "risk_metrics_heading": "风险收益分析",
        "risk_reward_ratio_label": "风险收益比",
        "potential_upside_label": "潜在收益空间",
        "potential_downside_label": "潜在亏损空间",
        "max_drawdown_label": "最大回撤",
        "volatility_label": "波动率",
    ...
    "en": {
        ...
        "factor_scores_heading": "Multi-Dimensional Scores",
        "factor_technical_label": "Technical",
        "factor_fundamental_label": "Fundamental",
        "factor_sentiment_label": "Sentiment",
        "factor_capital_flow_label": "Capital Flow",
        "factor_composite_label": "Composite",
        "financial_metrics_heading": "Key Financial Metrics",
        "pe_ratio_label": "P/E Ratio",
        "pb_ratio_label": "P/B Ratio",
        "roe_label": "ROE",
        "debt_ratio_label": "Debt Ratio",
        "revenue_growth_label": "Revenue Growth",
        "profit_growth_label": "Profit Growth",
        "dividend_yield_label": "Dividend Yield",
        "market_cap_label": "Market Cap",
        "sector_comparison_heading": "Sector Comparison",
        "sector_name_label": "Sector",
        "sector_rank_label": "Sector Rank",
        "sector_trend_label": "Sector Trend",
        "peer_avg_pe_label": "Peer Avg P/E",
        "relative_strength_label": "Relative Strength",
        "sector_leading_label": "Sector Leader",
        "risk_metrics_heading": "Risk-Reward Analysis",
        "risk_reward_ratio_label": "Risk-Reward Ratio",
        "potential_upside_label": "Potential Upside",
        "potential_downside_label": "Potential Downside",
